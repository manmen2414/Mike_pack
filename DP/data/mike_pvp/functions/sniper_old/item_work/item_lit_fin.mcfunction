...
execute if entity @a[distance=..128] run summon minecraft:creeper ~ ~ ~0.1 {ExplosionRadius:-3b,Fuse:0s,ignited:1b,Tags:["creep"]}
execute if entity @a[distance=..128] run summon minecraft:creeper ~0.1 ~ ~ {ExplosionRadius:-3b,Fuse:0s,ignited:1b,Tags:["creep"]}
execute as @e[distance=..3.5,tag=!creep] run damage @s 11 minecraft:player_explosion by @r[tag=pross_16]
execute as @e[distance=3.5..7.7,tag=!creep] run damage @s 9 minecraft:player_explosion by @r[tag=pross_16]
execute as @e[distance=7.7..10,tag=!creep] run damage @s 5 minecraft:player_explosion by @r[tag=pross_16]
execute as @e[distance=10..12.5,tag=!creep] run damage @s 3 minecraft:player_explosion by @r[tag=pross_16]
