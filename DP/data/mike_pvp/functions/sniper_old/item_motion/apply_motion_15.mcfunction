...
execute store result entity @s Motion[0] double 0.051 run scoreboard players operation @s snipermotx2 -= @s snipermotx1
execute store result entity @s Motion[1] double 0.051 run scoreboard players operation @s snipermoty2 -= @s snipermoty1
execute store result entity @s Motion[2] double 0.051 run scoreboard players operation @s snipermotz2 -= @s snipermotz1
