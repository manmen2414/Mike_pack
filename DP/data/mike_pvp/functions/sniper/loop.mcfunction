...
execute as @a[scores={right_click=1.., snipercd=0},nbt={SelectedItem:{tag:{hstype:18}}}] at @s run function mike_pvp:sniper/item_work/item_btr_brs
...
# Effects & Considering
execute as @e[tag=brusted] at @s run function mike_pvp:sniper/item_motion/processing
