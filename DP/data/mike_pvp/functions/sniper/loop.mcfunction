...
execute as @a[scores={right_click=1.., snipercd=0},nbt={SelectedItem:{tag:{hstype:15}}}] at @s run function mike_pvp:sniper/item_eag_brs
...
execute as @e[scores={snipercd=1..}, type=!minecraft:player] at @s run particle minecraft:flame ~ ~ ~ 0 0 0 10 0 normal
